...
object Snoozling : CropDefinitionProvider {
    override val definition = CropDefinition(
        ...
        stageDefs = listOf(
            CropStage(
                blocks = listOf( //todo add the pattern to help with this kind of duplication.
                    CropBlockState(
            ...
            CropStage(
                ...
                armorStands = listOf(
                    CropArmorStand(
                        offset = Vec3(1.03125, 0.25, 1.34375),
                        matcher = {
                            it == "b82d442528456547474dd88166a97818f057ecc4b3ed350ef9a5e4dbd27f98d7"
                        }
                    ),
            ...
            CropStage(
                ...
                armorStands = listOf(
                    ...
                    CropArmorStand(
                        offset = Vec3(1.03125, -0.59375, 1.125),
                        matcher = {
                            it == "b82d442528456547474dd88166a97818f057ecc4b3ed350ef9a5e4dbd27f98d7"
                        }
                    ),
...
it.isBlock("minecraft:wheat") &&
    ...
    matcher = {
        ...
        CropArmorStand(
    offset = Vec3(1.5, 2.411999999999992, 1.5),
    matcher = {

    }
),
        CropArmorStand(
    offset = Vec3(1.5, 2.0419999999999874, 1.5),
    matcher = {
        it.name.isNotBlank()
    }
),
        CropArmorStand(
    offset = Vec3(1.5, 1.6719999999999828, 1.5),
    matcher = {
        it.name == "Right-click to wake up!"
    }
)
    ),
    5..5
