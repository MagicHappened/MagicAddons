...
//    val elementInstances: List<GreenhouseElementInstance>
//)

val GREENHOUSE_LAYOUT_CODEC: Codec<GreenhouseLayout> =
...
val GROWTH_STAGE_INFO_CODEC: Codec<GrowthStageInfo> = RecordCodecBuilder.create { instance ->
    instance.group(
...
val GREENHOUSE_ELEMENT_INSTANCE_CODEC: Codec<GreenhouseElementInstance> = RecordCodecBuilder.create { instance ->
    instance.group(
...
val GRID_STATE_CODEC: Codec<GridState> = RecordCodecBuilder.create { instance ->
    instance.group(
...
val GREENHOUSE_SLOT_CODEC: Codec<GreenhouseSlot> = RecordCodecBuilder.create { instance ->
    instance.group(
...
val GREENHOUSE_GRID_CODEC: Codec<GreenhouseGrid> = RecordCodecBuilder.create { instance ->
    instance.group(
        GRID_STATE_CODEC
            .fieldOf("state")
            .forGetter { it.state }
