...
data class GreenhouseLayout(
    ...
    fun plotTitle(plot: PlotLayout): String = plot.name ?: "Plot ${plots.indexOf(plot) + 1}"

    /** One more empty plot at the end of the list. */
    fun addPlot(): PlotLayout = PlotLayout(id = freePlotId()).also { plots.add(it) }
    ...
    companion object {
        ...
        fun of(layout: PlotLayout): GreenhouseLayout =
